...
CREATE TABLE `tb_staff` (
  ...
  KEY `ORDER_TAKEN_idx` (`ORDER_TAKEN`),
  CONSTRAINT `ORDER_TAKEN` FOREIGN KEY (`ORDER_TAKEN`) REFERENCES `tb_orders` (`ORDER_ID`)
...
INSERT INTO `tb_staff` VALUES (1,'Alice','Waiter',1),(2,'Bob','Waiter',2),(3,'Charlie','Bartender',3),(4,'David','Waiter',4),(5,'Eva','Waiter',5);
